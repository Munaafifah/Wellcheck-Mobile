class DiseasePrecautionService {
  static const Map<String, List<String>> _precautions = {
  ...
  static List<String> getPrecautions(String disease) {
    return _precautions[disease] ?? ["No specific precautions available"];
  }
}